...
class Memory {
  ...
  // allocate(size) - reserves a contiguous block of memory 
  // consisting of size boxes which you can safely modify, 
  ...
  // copy(to, from, size) - copies size boxes of data from the 
  // from pointer to the to pointer (for example, copy(10, 0, 3) 
  // would copy the values at boxes 0, 1 and 2 to the boxes at 
